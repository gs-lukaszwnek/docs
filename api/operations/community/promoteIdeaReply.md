---
url: >-
  https://developer-portal.gainsight.com/docs/api/operations/community/promoteIdeaReply.md
---
...
```
POST https://api2-eu-west-1.insided.com/v2/ideas/replies/{id}/promote
```
