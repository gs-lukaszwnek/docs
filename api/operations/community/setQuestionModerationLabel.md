---
url: >-
  https://developer-portal.gainsight.com/docs/api/operations/community/setQuestionModerationLabel.md
---
...
```
POST https://api2-eu-west-1.insided.com/v2/questions/setModerationLabel
```
...
| Status | Description |
|--------|-------------|
| 204 | Moderation label was set to question |
| 404 | Item not found |
