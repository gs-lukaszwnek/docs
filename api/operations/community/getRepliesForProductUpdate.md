---
url: >-
  https://developer-portal.gainsight.com/docs/api/operations/community/getRepliesForProductUpdate.md
---
...
```
GET https://api2-eu-west-1.insided.com/v2/productUpdates/{id}/replies
```
...
|------|----|------|----------|-------------|
| `id` | path | string | Yes | ID of the productUpdate to fetch replies for |
