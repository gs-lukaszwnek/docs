---
url: >-
  https://developer-portal.gainsight.com/docs/api/operations/community/addIdeaModeratorTags.md
---
...
```
POST https://api2-eu-west-1.insided.com/v2/ideas/{id}/moderator-tags/add
```
