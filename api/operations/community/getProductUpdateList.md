---
url: >-
  https://developer-portal.gainsight.com/docs/api/operations/community/getProductUpdateList.md
---
...
Fetches a paginated list of productUpdates sorted by last activity in descending order. Last activity is the time the productUpdate was last replied.

## Endpoint

```
GET https://api2-eu-west-1.insided.com/v2/productUpdates
```
