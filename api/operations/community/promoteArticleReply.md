---
url: >-
  https://developer-portal.gainsight.com/docs/api/operations/community/promoteArticleReply.md
---
...
```
POST https://api2-eu-west-1.insided.com/v2/articles/replies/{id}/promote
```
