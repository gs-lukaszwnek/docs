---
url: >-
  https://developer-portal.gainsight.com/docs/api/operations/community/editProductUpdateReply.md
---
...
```
POST https://api2-eu-west-1.insided.com/v2/productUpdates/replies/{id}/editContent
```
