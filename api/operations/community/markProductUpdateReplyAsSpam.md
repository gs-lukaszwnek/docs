---
url: >-
  https://developer-portal.gainsight.com/docs/api/operations/community/markProductUpdateReplyAsSpam.md
---
...
```
POST https://api2-eu-west-1.insided.com/v2/productUpdates/replies/{id}/markAsSpam
```
...
| Status | Description |
|--------|-------------|
| 204 | ProductUpdate reply marked as spam |
