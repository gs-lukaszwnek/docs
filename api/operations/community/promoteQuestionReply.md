---
url: >-
  https://developer-portal.gainsight.com/docs/api/operations/community/promoteQuestionReply.md
---
...
```
POST https://api2-eu-west-1.insided.com/v2/questions/replies/{replyId}/promote
```
