---
url: >-
  https://developer-portal.gainsight.com/docs/api/operations/community/getRepliesForQuestion.md
---
...
```
GET https://api2-eu-west-1.insided.com/v2/questions/{id}/replies
```
