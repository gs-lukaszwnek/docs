---
url: >-
  https://developer-portal.gainsight.com/docs/api/operations/community/replyArticle.md
---
...
```
POST https://api2-eu-west-1.insided.com/v2/articles/{id}/reply
```
